//Receiver//These are needed for MPU
#include "I2Cdev.h"
...
void loop() 
{
  ...
  {  
    ...
    // Swapped ypr[1] (pitch) and ypr[2] (roll) to fix the control axes.
    int xAxisValue = constrain(ypr[1] * 180/M_PI, -90, 90);
    int yAxisValue = constrain(ypr[2] * 180/M_PI, -90, 90);
    // ========================================================================
